...
<div class="tabs">
		...
		<ul class="tabs">
			...
			<li class="active" id="tab1"><a href="${path}/admin/adminReport" class="alinkEx1">처리전</a></li>

			<li id="tab2"><a href="${path}/admin/adminReportAfter" class="alinkEx2">처리완료</a></li>
			...
			<div class="board_list_wrap">
				<div class="board_list">
					<div class="board_list_head">
		                ...
		                <div class="col">신고유형</div>
		                <div class="col">제목</div>
		                <div class="col">날짜</div>
		                <div class="col">처리유무</div>
		                <div class="col">신고자 닉네임</div>
		                <div class="col">피신고자 닉네임</div>
		                <div class="col">경고</div>
		        </div>
