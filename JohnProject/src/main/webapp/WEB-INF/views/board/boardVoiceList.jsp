	...
	<div id="result" class="glider">
		...
		<div class="card-list">
	      ...
	      <div class="card-list">
	      	...
	      	<div class="card1" onclick="location.href='${path}/board/boardPage?boardNo=${item.BOARD_ID }'">
	        <div class="card1-header">
	          <p><fmt:formatDate value="${item.ENROLL_DATE}" pattern="yyyy년 MM월 dd일"/>2020년 03월 23
	          <span class="hits">
					<ion-icon class="heart" name="heart-outline"></ion-icon> ${item.LIKE_NUM }
				</span></p>
			...
			<div class="icons">
				<div class="judge">
					<ion-icon name="thumbs-up-outline"></ion-icon> ${item.AGREE_NUM } 3
					<ion-icon name="thumbs-down-outline"></ion-icon> ${item.DISAGREE_NUM } 3
				</div>
			</div>
...
<script defer>
	...
	function mkCard(item){
		...
		if(item.WRITER_PROFILE==null){
			html += "<img src=\"${path }/resources/images/avatar.png\" />";
		}else {
			html += "<img src=\"${path }/resources/images/"+item.WRITER_PROFILE+"\" />";
		}
		html += "</a>";
