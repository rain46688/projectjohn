...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	...
	<section id="content">
        ...
        <br>
        <button class="btn btn-outline-info" onclick="noticeViewModify();">수정</button>
        <button class="btn btn-outline-info" onclick="noticeViewDelete();">삭제</button>
    </div>
	...
	<script>
		...
		function noticeViewModify(){
			
		}
		
		function noticeViewDelete(){
